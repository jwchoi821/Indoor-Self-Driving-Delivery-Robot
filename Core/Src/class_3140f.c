...
void class_3140f(void) {
	...
	while (x > -3.0f) {
		...
		__HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_1, 3000); // 오른쪽
	...
	while (x < -0.5f) {
		...
		__HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_1, 3000); // 오른쪽
		__HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_2, 5000);  // 왼쪽
	}
